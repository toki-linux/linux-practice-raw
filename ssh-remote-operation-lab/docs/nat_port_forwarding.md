...
この場合、Mac自身の22番ポートへ接続しようとするため、VirtualBoxの2222番ポートフォワーディングには届かない。

---

## ncでポートフォワーディングを確認した結果
...
この設定により、接続元Macでは以下のコマンドを実行することで、Ubuntu VMのSSHサービスへ接続できる。
